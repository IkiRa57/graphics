...
int main( void )
{
    ...
    GLuint programID1 = LoadShaders( "SimpleTransform.vertexshader", "FirstTriangle.fragmentshader" );
    GLuint programID2 = LoadShaders( "SimpleTransform.vertexshader", "SecondTriangle.fragmentshader" );
	...
	do{
        glm::mat4 View = glm::lookAt(
                glm::vec3(r*cos(alpha),3,r*sin(alpha)),
                glm::vec3(0,0,0),
                glm::vec3(0,1,0)
        );
